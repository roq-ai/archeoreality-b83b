...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Histories', path: '/histories', entity: 'history', service: AccessServiceEnum.PROJECT, icon: FiBookOpen },
    { name: 'Tickets', path: '/tickets', entity: 'ticket', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Tours', path: '/tours', entity: 'tour', service: AccessServiceEnum.PROJECT, icon: FiMap },
